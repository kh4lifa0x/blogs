...
image:
  path: apt35.jpeg
  alt: "Threat Profile: APT35 (Charming Kitten)"
media_subpath: /assets/img/posts/inside-apt35-irans-state-sponsored-cyber-espionage
toc: true
---
...
A prominent folder titled **“All\_Proxy\_Shell\_Targets”** contains subdirectories for **Iran, South Korea, Kuwait, Turkey, Saudi Arabia, and Lebanon**, documenting exploitation activities against **Microsoft Exchange servers** through **ProxyShell vulnerabilities**. This aligns with Charming Kitten’s established tactics of compromising **email infrastructures** to obtain **persistent access to sensitive communications**.
